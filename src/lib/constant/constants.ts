export const CLIENTS = [
  { alt: 'client1', logo: '/images/client1.png' },
  { alt: 'client2', logo: '/images/client2.png' },
  { alt: 'client3', logo: '/images/client3.png' },
  { alt: 'client4', logo: '/images/client4.png' },
  { alt: 'client5', logo: '/images/client5.png' },
];
export const USERS = [
  {
    name: 'Alice',
