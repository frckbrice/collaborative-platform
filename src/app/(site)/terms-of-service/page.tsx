    ...
    <main className="min-h-screen flex flex-col items-center py-20 px-4 bg-background">
      <section className="max-w-3xl w-full bg-white/10 rounded-xl p-8 pb-0 shadow-lg">
        ...
        <p className="mb-4 text-muted-foreground">
          By using av-digital-workspaces, you agree to these Terms of Service. Please read them
        ...
        <p className="mb-4 text-muted-foreground">
          All content, trademarks, and data on av-digital-workspaces are the property of
          av-digital-workspaces Inc. or its licensors. You may not use our branding without
          permission.
        </p>
        <h2 className="text-2xl font-semibold mb-2">4. Termination</h2>
        <p className="mb-4 text-muted-foreground">
          We may suspend or terminate your access to av-digital-workspaces at any time for violation
          of these terms or for any other reason.
        </p>
        <h2 className="text-2xl font-semibold mb-2">5. Limitation of Liability</h2>
        <p className="mb-4 text-muted-foreground">
          av-digital-workspaces is provided &quot;as is&quot; without warranties. We are not liable
        ...
        <p className="mb-4 text-muted-foreground">
          ...
          av-digital-workspaces means you accept the revised terms.
        </p>
