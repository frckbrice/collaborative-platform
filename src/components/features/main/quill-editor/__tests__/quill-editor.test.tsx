...
vi.mock('@/lib/supabase/queries', () => ({
  getWorkspaceDetails: vi.fn(() => ({
    data: [{ id: 'test-workspace', title: 'Test Workspace' }],
    error: null,
  })),
  getFolderDetails: vi.fn(() => ({
    data: [{ id: 'test-folder', title: 'Test Folder' }],
    error: null,
  })),
...
describe('QuillEditor Component', () => {
  ...
  it('renders QuillEditor with basic structure', async () => {
    render(<QuillEditor dirDetails={mockDirDetails} fileId="test-file-id" dirType="file" />);
  ...
  it('handles different directory types correctly', async () => {
    const { rerender } = render(
      <QuillEditor dirDetails={mockDirDetails} fileId="test-file-id" dirType="workspace" />
    );
    ...
    // Test folder type
    rerender(<QuillEditor dirDetails={mockDirDetails} fileId="test-file-id" dirType="folder" />);
    expect(screen.getByText('Test Document')).toBeInTheDocument();
  });
