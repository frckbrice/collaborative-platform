...
exports.priceRelations = exports.productRelations = exports.collaborators = exports.files = exports.__drizzle_migrations = exports.subscriptions = exports.prices = exports.products = exports.customers = exports.users = exports.folders = exports.workspaces = exports.migrations = exports.equality_op = exports.action = exports.subscription_status = exports.pricing_type = exports.pricing_plan_interval = exports.key_type = exports.key_status = exports.one_time_token_type = exports.factor_type = exports.factor_status = exports.code_challenge_method = exports.aal_level = void 0;
...
exports.key_status = (0, pg_core_1.pgEnum)('key_status', ['default', 'valid', 'invalid', 'expired']);
...
exports.action = (0, pg_core_1.pgEnum)('action', ['INSERT', 'UPDATE', 'DELETE', 'TRUNCATE', 'ERROR']);
exports.equality_op = (0, pg_core_1.pgEnum)('equality_op', ['eq', 'neq', 'lt', 'lte', 'gt', 'gte', 'in']);
...
exports.prices = (0, pg_core_1.pgTable)('prices', {
    id: (0, pg_core_1.text)('id').primaryKey().notNull(),
    product_id: (0, pg_core_1.text)('product_id').references(function () { return exports.products.id; }),
    active: (0, pg_core_1.boolean)('active'),
    description: (0, pg_core_1.text)('description'),
    // You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
exports.subscriptions = (0, pg_core_1.pgTable)('subscriptions', {
    ...
    price_id: (0, pg_core_1.text)('price_id')
        .references(function () { return exports.prices.id; })
        .references(function () { return exports.prices.id; }),
    ...
    created: (0, pg_core_1.timestamp)('created', { withTimezone: true, mode: 'string' })
        ...
        .notNull(),
    current_period_start: (0, pg_core_1.timestamp)('current_period_start', { withTimezone: true, mode: 'string' })
        .default((0, drizzle_orm_1.sql)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["now()"], ["now()"]))))
        .notNull(),
    current_period_end: (0, pg_core_1.timestamp)('current_period_end', { withTimezone: true, mode: 'string' })
        .default((0, drizzle_orm_1.sql)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["now()"], ["now()"]))))
        .notNull(),
    ended_at: (0, pg_core_1.timestamp)('ended_at', { withTimezone: true, mode: 'string' }).default((0, drizzle_orm_1.sql)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["now()"], ["now()"])))),
    cancel_at: (0, pg_core_1.timestamp)('cancel_at', { withTimezone: true, mode: 'string' }).default((0, drizzle_orm_1.sql)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["now()"], ["now()"])))),
    canceled_at: (0, pg_core_1.timestamp)('canceled_at', { withTimezone: true, mode: 'string' }).default((0, drizzle_orm_1.sql)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["now()"], ["now()"])))),
    trial_start: (0, pg_core_1.timestamp)('trial_start', { withTimezone: true, mode: 'string' }).default((0, drizzle_orm_1.sql)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["now()"], ["now()"])))),
    trial_end: (0, pg_core_1.timestamp)('trial_end', { withTimezone: true, mode: 'string' }).default((0, drizzle_orm_1.sql)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["now()"], ["now()"])))),
});
...
exports.files = (0, pg_core_1.pgTable)('files', {
    ...
    folder_id: (0, pg_core_1.uuid)('folder_id')
        .notNull()
        .references(function () { return exports.folders.id; }, { onDelete: 'cascade' }),
    workspace_id: (0, pg_core_1.uuid)('workspace_id')
        .notNull()
        .references(function () { return exports.workspaces.id; }, { onDelete: 'cascade' }),
});
